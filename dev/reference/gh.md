...
#>     "updated_at": "2026-05-27T21:38:10Z",
#>     "pushed_at": "2026-05-27T14:10:17Z",
...
#>     "updated_at": "2026-05-28T17:58:34Z",
#>     "pushed_at": "2026-05-28T19:07:13Z",
...
#> [
#>   {
#>     "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7840",
#>     "repository_url": "https://api.github.com/repos/tidyverse/dplyr",
#>     "labels_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7840/labels{/name}",
#>     "comments_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7840/comments",
#>     "events_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7840/events",
#>     "html_url": "https://github.com/tidyverse/dplyr/pull/7840",
#>     "id": 4508814749,
#>     "node_id": "PR_kwDOAGIUpc7epr9j",
#>     "number": 7840,
#>     "title": "Feature: group_modify() in R/group-map.R",
#>     "user": {
#>       "login": "iamYannC",
#>       "id": 130578277,
#>       "node_id": "U_kgDOB8h3ZQ",
#>       "avatar_url": "https://avatars.githubusercontent.com/u/130578277?v=4",
#>       "gravatar_id": "",
#>       "url": "https://api.github.com/users/iamYannC",
#>       "html_url": "https://github.com/iamYannC",
#>       "followers_url": "https://api.github.com/users/iamYannC/followers",
#>       "following_url": "https://api.github.com/users/iamYannC/following{/other_user}",
#>       "gists_url": "https://api.github.com/users/iamYannC/gists{/gist_id}",
#>       "starred_url": "https://api.github.com/users/iamYannC/starred{/owner}{/repo}",
#>       "subscriptions_url": "https://api.github.com/users/iamYannC/subscriptions",
#>       "organizations_url": "https://api.github.com/users/iamYannC/orgs",
#>       "repos_url": "https://api.github.com/users/iamYannC/repos",
#>       "events_url": "https://api.github.com/users/iamYannC/events{/privacy}",
#>       "received_events_url": "https://api.github.com/users/iamYannC/received_events",
#>       "type": "User",
#>       "user_view_type": "public",
#>       "site_admin": false
#>     },
...
#>     "milestone": {},
#>     "comments": 0,
#>     "created_at": "2026-05-23T16:04:02Z",
#>     "updated_at": "2026-05-24T17:57:32Z",
#>     "closed_at": {},
#>     "assignee": {},
...
#>     "draft": false,
#>     "pull_request": {
#>       "url": "https://api.github.com/repos/tidyverse/dplyr/pulls/7840",
#>       "html_url": "https://github.com/tidyverse/dplyr/pull/7840",
#>       "diff_url": "https://github.com/tidyverse/dplyr/pull/7840.diff",
#>       "patch_url": "https://github.com/tidyverse/dplyr/pull/7840.patch",
#>       "merged_at": {}
#>     },
...
#>     "closed_by": {},
#>     "reactions": {
#>       "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7840/reactions",
#>       "total_count": 0,
#>       "+1": 0,
#>       "-1": 0,
#>       "laugh": 0,
...
#>       "eyes": 0
#>     },
#>     "timeline_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7840/timeline",
#>     "performed_via_github_app": {},
#>     "state_reason": {}
#>   },
#>   {
#>     "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7839",
#>     "repository_url": "https://api.github.com/repos/tidyverse/dplyr",
#>     "labels_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7839/labels{/name}",
#>     "comments_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7839/comments",
#>     "events_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7839/events",
#>     "html_url": "https://github.com/tidyverse/dplyr/issues/7839",
#>     "id": 4508706904,
#>     "node_id": "I_kwDOAGIUpc8AAAABDL1oWA",
#>     "number": 7839,
#>     "title": "feature: A proposed change to `group_modify` - with tidyselection and .by argument",
#>     "user": {
#>       "login": "iamYannC",
#>       "id": 130578277,
#>       "node_id": "U_kgDOB8h3ZQ",
...
#>     "milestone": {},
#>     "comments": 1,
#>     "created_at": "2026-05-23T15:28:25Z",
#>     "updated_at": "2026-05-24T01:23:24Z",
#>     "closed_at": {},
#>     "assignee": {},
#>     "author_association": "NONE",
#>     "issue_field_values": [],
...
#>       "total_blocking": 0
#>     },
#>     "body": "tidyverse users are used to the `.by`​ syntax with tidy name selection.\nThe current implementation of `group_modify`​ doesnt support that.\n\nI am offering a fix that:\n* doesnt break previous syntax\n* offers a more natural syntax\n\nMy motivation was working on my ggplot2 extension, so my example is a simple median-IQR function that returns a data frame, just for reference:\n```\nmd_iqr <- function(x,center = 0.5, spread = c(0.25, 0.75)){\n  c <- quantile(x,center)\n  s <- quantile(x,spread)\n  data <- data.frame(y = c, ymin = min(s), ymax = max(s))\n  \n  return(data)\n}\n```\nThe current use is a bit clunky:\n`> mtcars |> group_by(gear) |> group_modify(~md_iqr(.x$mpg))`\n\n## My suggestion:\nFor these examples, I created a function `group_modify_` to distinguish from the current function. so this is for demo purposes.. the PR has the correct internal functions update\n\n```\n> mtcars |> group_modify_(.f = md_iqr,.col = mpg, .by = gear)\n# A tibble: 3 × 4\n   gear     y  ymin  ymax\n* <dbl> <dbl> <dbl> <dbl>\n1     3  15.5  14.5  18.4\n2     4  22.8  21    28.1\n3     5  19.7  15.8  26  \n```\n* You could also pass positional arguments as well as function specific arguments:\n```\n> mtcars |> group_modify_(md_iqr,mpg,gear, spread = c(0.1,0.9))\n# A tibble: 3 × 4\n   gear     y  ymin  ymax\n* <dbl> <dbl> <dbl> <dbl>\n1     3  15.5  11.6  20.5\n2     4  22.8  19.4  32.2\n3     5  19.7  15.3  28.6\n```\n* It works well on un-gropued data as well:\n```\n> mtcars |> group_modify_(md_iqr,mpg)\n# A tibble: 1 × 3\n      y  ymin  ymax\n  <dbl> <dbl> <dbl>\n1  19.2  15.4  22.8\n```\n* It doesnt break and doesnt change the original behaviour!\n```\n> mtcars |> group_by(gear) |> group_modify_(~md_iqr(.x$mpg))\n# A tibble: 3 × 4\n# Groups:   gear [3]\n   gear     y  ymin  ymax\n  <dbl> <dbl> <dbl> <dbl>\n1     3  15.5  14.5  18.4\n2     4  22.8  21    28.1\n3     5  19.7  15.8  26\n```\nStill supports formula notation and returns an expected grouped tibble.\n\n* From current examples:\n```\nmtcars |> group_by(gear) |> group_modify(~head(.x,2)) |> ungroup()\n# becomes this:\nmtcars |> group_modify(.f = head,.by = gear, n = 2)\n```\nboth are valid, my suggestions extendes the API, it doesn't replace or break or limits anyone",
#>     "closed_by": {},
#>     "reactions": {
#>       "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7839/reactions",
#>       "total_count": 0,
#>       "+1": 0,
#>       "-1": 0,
#>       "laugh": 0,
...
#>       "eyes": 0
#>     },
#>     "timeline_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7839/timeline",
#>     "performed_via_github_app": {},
#>     "state_reason": {},
#>     "pinned_comment": {}
#>   },
...
#>     "updated_at": "2025-12-15T20:45:56Z",
#>     "closed_at": {},
#>     "assignee": {},
#>     "author_association": "NONE",
#>     "issue_field_values": [],
