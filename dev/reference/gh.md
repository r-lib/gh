...
R sessions. Entries are partitioned by token, so responses cached for
one token are never replayed for another. When the cache holds a
previous response for a request, `gh()` lets httr2 attach
`If-None-Match` / `If-Modified-Since` headers automatically and replays
the cached body on a `304 Not Modified` reply, so the call doesn't count
against your GitHub rate limit. Set `options(gh_cache = FALSE)` to
disable, or delete the directory above to clear it.
...
[`gh_whoami()`](https://gh.r-lib.org/dev/reference/gh_whoami.md) for
details on GitHub API token management.
...
#>     "updated_at": "2026-09-01T00:24:46Z",
#>     "pushed_at": "2026-09-01T16:13:51Z",
...
#>     "updated_at": "2026-09-02T02:25:57Z",
#>     "pushed_at": "2026-09-02T02:25:41Z",
...
#> [
#>   {
#>     "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7854",
#>     "repository_url": "https://api.github.com/repos/tidyverse/dplyr",
#>     "labels_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7854/labels{/name}",
#>     "comments_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7854/comments",
#>     "events_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7854/events",
#>     "html_url": "https://github.com/tidyverse/dplyr/issues/7854",
#>     "id": 5311004972,
#>     "node_id": "I_kwDOAGIUpc8AAAABPI-BLA",
#>     "number": 7854,
#>     "title": "Unexpected behavior of pick() as compared to cur_data() related to list columns: with rowwise(), pick() generates tibbles with more than one row",
#>     "user": {
#>       "login": "january3",
#>       "id": 11678838,
#>       "node_id": "MDQ6VXNlcjExNjc4ODM4",
#>       "avatar_url": "https://avatars.githubusercontent.com/u/11678838?v=4",
#>       "gravatar_id": "",
#>       "url": "https://api.github.com/users/january3",
#>       "html_url": "https://github.com/january3",
#>       "followers_url": "https://api.github.com/users/january3/followers",
#>       "following_url": "https://api.github.com/users/january3/following{/other_user}",
#>       "gists_url": "https://api.github.com/users/january3/gists{/gist_id}",
#>       "starred_url": "https://api.github.com/users/january3/starred{/owner}{/repo}",
#>       "subscriptions_url": "https://api.github.com/users/january3/subscriptions",
#>       "organizations_url": "https://api.github.com/users/january3/orgs",
#>       "repos_url": "https://api.github.com/users/january3/repos",
#>       "events_url": "https://api.github.com/users/january3/events{/privacy}",
#>       "received_events_url": "https://api.github.com/users/january3/received_events",
#>       "type": "User",
#>       "user_view_type": "public",
#>       "site_admin": false
#>     },
...
#>     "milestone": {},
#>     "comments": 0,
#>     "created_at": "2026-09-01T11:02:23Z",
#>     "updated_at": "2026-09-01T14:29:00Z",
#>     "closed_at": {},
#>     "assignee": {},
...
#>       "total_blocking": 0
#>     },
#>     "body": "Summary: if a tibble has a list column, and elements of that list column are vectors/lists with more than one element, then with `rowwise()`, `pick()` will return tibbles containing more than one row - unlike `cur_data()`.\n\nConsider the following example of a tibble with a list column and a function that takes a tibble with a single row:\n\n```\ndata <- tibble(id = 1:2, ll = list(list(x=1, y=10),\n                                   list(x=2, y=20)))\n\nff <- function(df) {\n  print(\"ff called\")\n  print(df)\n  df$ll[[1]]$x + 1\n}\n```\n\n(it doesn't matter whether `ll=list(list(x=1,y=10), list(x=2, y=20))` or whether `ll=list(c(x=1,y=10), c(x=2,y=20))`).\n\nI want to apply the function `ff` to every row of the `data` tibble. With the (deprecated) `cur_data()`, I can do it like this:\n\n```\ndata |>\n  rowwise() |>\n  mutate(new_x = ff(cur_data()))\n```\n\nOutput:\n\n```\n⏹ > data |>\n+   rowwise() |>\n+   mutate(new_x = ff(cur_data()))\n[1] \"ff called\"\n# Tibble (class tbl_df) 2 x 1:\n │id   │ll          \n1│    1│<list: 2 el>\n[1] \"ff called\"\n# Tibble (class tbl_df) 2 x 1:\n │id   │ll          \n1│    2│<list: 2 el>\n# Tibble (class tbl_df) 3 x 2:\n │id   │ll          │new_x\n1│    1│<list: 2 el>│    2\n2│    2│<list: 2 el>│    3\nWarning message:\nThere was 1 warning in `mutate()`.\nℹ In argument: `new_x = ff(cur_data())`.\nℹ In row 1.\nCaused by warning:\n! `cur_data()` was deprecated in dplyr 1.1.0.\nℹ Please use `pick()` instead.\nThis warning is displayed once per session.\nCall `lifecycle::last_lifecycle_warnings()` to see where this warning was\ngenerated. \n```\n\nThis is what I expect: each time `ff` gets called, it is called with a tibble which has one row exactly and the element in the `ll` column is a list containing elements `x` and `y`.\n\nHowever, if I try to run the same code with an equivalent `pick()` call, the tibbles passed to `ff` no longer have one row, but two:\n\nCode:\n\n```\ndata |>\n  rowwise() |>\n  mutate(new_x = ff(pick(id, ll)))\n```\n\nResult:\n\n```\n⏹ > data |>\n+   rowwise() |>\n+   mutate(new_x = ff(pick(id, ll)))\n[1] \"ff called\"\n# Tibble (class tbl_df) 2 x 2:\n │id   │ll          \n1│    1│<list: 1 el>\n2│    1│<list: 1 el>\nError in `mutate()`:\nℹ In argument: `new_x = ff(pick(id, ll))`.\nℹ In row 1.\nCaused by error in `df$ll[[1]]$x`:\n! $ operator is invalid for atomic vectors\nRun `rlang::last_trace()` to see where the error occurred.\n```\n\nIt appears that the new tibble created by `pick()` unlisted the list column `ll`, resulting in its individual elements now populating separate rows, while elements of other columns (such as `id`) were duplicated. Here is what can be seen in `dplyr_pick_tibble` called from `pick`:\n\n```\n⏹ > debugonce(dplyr:::dplyr_pick_tibble)\n⏹ > data |>\n+   rowwise() |>\n+   mutate(new_x = ff(pick(id, ll)))\n[1] \"ff called\"\ndebugging in: asNamespace(\"dplyr\")$dplyr_pick_tibble(id = id, ll = ll)\ndebug: {\n    error_call <- call(\"pick\")\n    out <- list2(...)\n    size <- vec_size_common(!!!out, .absent = 1L, .call = error_call)\n    out <- vec_recycle_common(!!!out, .size = size, .call = error_call)\n    dplyr_new_tibble(out, size = size)\n}\nBrowse[1]> \ndebug: error_call <- call(\"pick\")\nBrowse[1]> \ndebug: out <- list2(...)\nBrowse[1]> \ndebug: size <- vec_size_common(!!!out, .absent = 1L, .call = error_call)\nBrowse[1]> \ndebug: out <- vec_recycle_common(!!!out, .size = size, .call = error_call)\nBrowse[1]> size\n[1] 2\nBrowse[1]> str(out)\nList of 2\n $ id: int 1\n $ ll:List of 2\n  ..$ x: num 1\n  ..$ y: num 10\nBrowse[1]> \n```\n\nThe outer `list()` is silently dropped, resulting in a list of length 2, and the `id` column gets recycled.",
#>     "closed_by": {},
#>     "reactions": {
#>       "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7854/reactions",
#>       "total_count": 0,
#>       "+1": 0,
#>       "-1": 0,
#>       "laugh": 0,
...
#>       "eyes": 0
#>     },
#>     "timeline_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7854/timeline",
#>     "performed_via_github_app": {},
#>     "state_reason": {},
#>     "pinned_comment": {}
#>   },
#>   {
#>     "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7853",
#>     "repository_url": "https://api.github.com/repos/tidyverse/dplyr",
#>     "labels_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7853/labels{/name}",
#>     "comments_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7853/comments",
#>     "events_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7853/events",
#>     "html_url": "https://github.com/tidyverse/dplyr/issues/7853",
#>     "id": 5277530911,
#>     "node_id": "I_kwDOAGIUpc8AAAABOpC7Hw",
#>     "number": 7853,
#>     "title": "unexpected behaviour of summarise with n(), everything() and logical tests",
#>     "user": {
#>       "login": "richardjtelford",
#>       "id": 5246541,
#>       "node_id": "MDQ6VXNlcjUyNDY1NDE=",
#>       "avatar_url": "https://avatars.githubusercontent.com/u/5246541?v=4",
#>       "gravatar_id": "",
#>       "url": "https://api.github.com/users/richardjtelford",
#>       "html_url": "https://github.com/richardjtelford",
#>       "followers_url": "https://api.github.com/users/richardjtelford/followers",
#>       "following_url": "https://api.github.com/users/richardjtelford/following{/other_user}",
#>       "gists_url": "https://api.github.com/users/richardjtelford/gists{/gist_id}",
#>       "starred_url": "https://api.github.com/users/richardjtelford/starred{/owner}{/repo}",
#>       "subscriptions_url": "https://api.github.com/users/richardjtelford/subscriptions",
#>       "organizations_url": "https://api.github.com/users/richardjtelford/orgs",
#>       "repos_url": "https://api.github.com/users/richardjtelford/repos",
#>       "events_url": "https://api.github.com/users/richardjtelford/events{/privacy}",
#>       "received_events_url": "https://api.github.com/users/richardjtelford/received_events",
#>       "type": "User",
#>       "user_view_type": "public",
#>       "site_admin": false
#>     },
...
#>     "milestone": {},
#>     "comments": 0,
#>     "created_at": "2026-08-28T11:00:22Z",
#>     "updated_at": "2026-08-28T11:00:22Z",
#>     "closed_at": {},
#>     "assignee": {},
#>     "author_association": "NONE",
#>     "issue_field_values": [],
...
#>       "total_blocking": 0
#>     },
#>     "body": "I'm getting some unexpected results with summarise() with across() everything() when the function in across() includes a logical test\n\n\n``` r\nsuppressPackageStartupMessages(library(dplyr))\n\n# across with specified columns and function sum(is.na) - works\npenguins  |> \n  select(bill_len:body_mass) |> \n  summarise(n = n(), across(bill_len:body_mass, \\(x) sum(is.na(x))))\n#>     n bill_len bill_dep flipper_len body_mass\n#> 1 344        2        2           2         2\n\n# across with everything() and function mean - works\npenguins |>  \n    select(bill_len:body_mass) |> \n  summarise(n = n(), across(everything(), \\(x) mean(x, na.rm = TRUE)))\n#>     n bill_len bill_dep flipper_len body_mass\n#> 1 344 43.92193 17.15117    200.9152  4201.754\n\n# across with everything() and function sum(is.na) - fails - n = 0\npenguins |>  \n    select(bill_len:body_mass) |> \n  summarise(n = n(), across(everything(), \\(x) sum(is.na(x))))\n#>   n bill_len bill_dep flipper_len body_mass\n#> 1 0        2        2           2         2\n\n# across with everything and sum(x > 0) - fails -  n = 1\npenguins |>  \n    select(bill_len:body_mass) |> \n  summarise(n = n(), across(everything(), \\(x) sum(x > 0, na.rm = TRUE)))\n#>   n bill_len bill_dep flipper_len body_mass\n#> 1 1      342      342         342       342\n```\n\n<sup>Created on 2026-08-28 with [reprex v2.1.1](https://reprex.tidyverse.org)<\/sup>\n\n",
#>     "closed_by": {},
#>     "reactions": {
#>       "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7853/reactions",
#>       "total_count": 0,
#>       "+1": 0,
#>       "-1": 0,
#>       "laugh": 0,
...
#>       "eyes": 0
#>     },
#>     "timeline_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7853/timeline",
#>     "performed_via_github_app": {},
#>     "state_reason": {},
#>     "pinned_comment": {}
#>   },
#>   {
#>     "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7852",
#>     "repository_url": "https://api.github.com/repos/tidyverse/dplyr",
#>     "labels_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7852/labels{/name}",
#>     "comments_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7852/comments",
#>     "events_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7852/events",
#>     "html_url": "https://github.com/tidyverse/dplyr/issues/7852",
#>     "id": 5134253893,
#>     "node_id": "I_kwDOAGIUpc8AAAABMgZ_RQ",
#>     "number": 7852,
#>     "title": "Incorrect translation to |>",
#>     "user": {
...
#>     "milestone": {},
#>     "comments": 0,
#>     "created_at": "2026-08-12T18:53:07Z",
#>     "updated_at": "2026-08-12T18:53:07Z",
#>     "closed_at": {},
#>     "assignee": {},
...
#>       "total_blocking": 0
#>     },
#>     "body": "https://github.com/tidyverse/dplyr/blob/d5e94e7fa8fd4a5f79c1a707d1842216bb4c691f/data-raw/starwars.R#L55\n\ncc @gaborcsardi did ddd989363a7be781a2c340bdf8f80d8eb5fb14c8 look for the `.` placeholder?",
#>     "closed_by": {},
#>     "reactions": {
#>       "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7852/reactions",
#>       "total_count": 0,
#>       "+1": 0,
#>       "-1": 0,
#>       "laugh": 0,
...
#>       "eyes": 0
#>     },
#>     "timeline_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7852/timeline",
#>     "performed_via_github_app": {},
#>     "state_reason": {},
#>     "pinned_comment": {}
#>   },
#>   {
#>     "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7851",
#>     "repository_url": "https://api.github.com/repos/tidyverse/dplyr",
#>     "labels_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7851/labels{/name}",
#>     "comments_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7851/comments",
#>     "events_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7851/events",
#>     "html_url": "https://github.com/tidyverse/dplyr/issues/7851",
#>     "id": 5022975670,
#>     "node_id": "I_kwDOAGIUpc8AAAABK2SGtg",
#>     "number": 7851,
#>     "title": "Feature request: make unmatched = \"error\" the default for mutating joins",
#>     "user": {
#>       "login": "mhuzzell",
#>       "id": 59931134,
#>       "node_id": "MDQ6VXNlcjU5OTMxMTM0",
#>       "avatar_url": "https://avatars.githubusercontent.com/u/59931134?v=4",
#>       "gravatar_id": "",
#>       "url": "https://api.github.com/users/mhuzzell",
#>       "html_url": "https://github.com/mhuzzell",
#>       "followers_url": "https://api.github.com/users/mhuzzell/followers",
#>       "following_url": "https://api.github.com/users/mhuzzell/following{/other_user}",
#>       "gists_url": "https://api.github.com/users/mhuzzell/gists{/gist_id}",
#>       "starred_url": "https://api.github.com/users/mhuzzell/starred{/owner}{/repo}",
#>       "subscriptions_url": "https://api.github.com/users/mhuzzell/subscriptions",
#>       "organizations_url": "https://api.github.com/users/mhuzzell/orgs",
#>       "repos_url": "https://api.github.com/users/mhuzzell/repos",
#>       "events_url": "https://api.github.com/users/mhuzzell/events{/privacy}",
#>       "received_events_url": "https://api.github.com/users/mhuzzell/received_events",
#>       "type": "User",
#>       "user_view_type": "public",
#>       "site_admin": false
#>     },
...
#>     "milestone": {},
#>     "comments": 2,
#>     "created_at": "2026-07-30T18:47:18Z",
#>     "updated_at": "2026-08-03T16:03:18Z",
#>     "closed_at": {},
#>     "assignee": {},
#>     "author_association": "NONE",
#>     "issue_field_values": [],
...
#>       "total_blocking": 0
#>     },
#>     "body": "Or an even better solution suggested below, but see my reasoning first. Feature request in title is because I suspect it would be easier to implement.\n\nI think that the current default of unmatched = \"drop\" is leading to people unwittingly dropping data that they intended to keep, especially in the context of the current behaviour around column names, whereby joins without a specified join key are joined by all matching columns, and joins _with_ a specified join key create .x and .y suffixed columns for any non-join columns with the same name. \n\nGiven this, prior to reading the detailed documentation of it, I had _thought_ that the default behaviour of mutating joins when not provided a join key was to treat all matching columns as join keys, and suffix all non-matching columns with the same name. I suggest that this should, in fact, be the default, since I can't be the only one with this misconception. **At the very least, it would be helpful to add a warning when data are dropped during a join**, since it is alarmingly easy to accidentally (and silently!) lose data when merging large dataframes with lots of shared columns. I think it would also be ideal to flag when data are dropped even when that is a specified behaviour. \n\nHowever, in my opinion  it would be better to make 'error' the default for unmatched (ideally naming the column as well as the row), and better still to have three options for unmatched data: 'drop', 'error', and 'suffix', where 'suffix' treats any same-named column as a non-joining column if there are any unmatched rows between x and y, and disambiguates them accordingly. Currently, as far as I understand there is no way to do this kind of merging easily and cleanly; instead it is necessary to learn in advance which columns do or do not match, and then create a join key based on that -- which can be a laborious process for large dfs. Using a full_join() will duplicate rows rather than columns, which is useful for not losing data, but inappropriate for many types of analysis. \n\nSo, currently:\n```\nlibrary(tidyverse)\nx <- tibble(a = 1, b = 2)\ny <- tibble(a = 1, b = 3)\n\n# join with key\nleft_join(x, y, by = \"a\")\n# A tibble: 1 × 3\n#      a   b.x   b.y\n#  <dbl> <dbl> <dbl>\n#1     1     2     3\n\n# join with no key\nleft_join(x, y)\n# A tibble: 1 × 2\n#      a     b\n#  <dbl> <dbl>\n#1     1     2\n\n# join with no key, unmatched option specified\nleft_join(x, y, unmatched = \"error\")\n# Error in `left_join()`:\n# ! Each row of `y` must be matched by `x`.\n# ℹ Row 1 of `y` was not matched.\n\n```\n\nSuggested change (BEST):\n```\n# join with no key, default \nleft_join(x, y)\n# A tibble: 1 × 3\n#      a   b.x   b.y\n#  <dbl> <dbl> <dbl>\n#1     1     2     3\n\n\n# join with no key, unmatched = \"drop\"\nleft_join(x, y, unmatched = \"drop\")\n# A tibble: 1 × 2\n#      a     b\n#  <dbl> <dbl>\n#1     1     2  \n# 1 rows dropped from `y` that did not match `x`.\n\n# join with no key, unmatched = \"error\"\nleft_join(x, y, unmatched = \"error\")\n# Error in `left_join()`:\n# ! Each row of `y` must be matched by `x`.\n# ℹ Row 1 of `y` was not matched at Column `b`.\n\n# join with no key, unmatched = \"suffix\" (suggested default) \nleft_join(x, y, unmatched = \"suffix\")\n# A tibble: 1 × 3\n#      a   b.x   b.y\n#  <dbl> <dbl> <dbl>\n#1     1     2     3\n```\n\nAlternative suggestion (second best, in my opinion):\n```\n# join with no key, default \nleft_join(x, y)\n# Error in `left_join()`:\n# ! Each row of `y` must be matched by `x`.\n# ℹ Row 1 of `y` was not matched at Column `b`.\n\n# join with no key, unmatched = \"drop\"\nleft_join(x, y, unmatched = \"drop\")\n# A tibble: 1 × 2\n#      a     b\n#  <dbl> <dbl>\n#1     1     2\n# 1 rows dropped from `y` that did not match `x`.\n```\n\nAbsolute minimum request:\n```\n# join with no key, default \nleft_join(x, y)\n# A tibble: 1 × 2\n#      a     b\n#  <dbl> <dbl>\n#1     1     2\n# Warning: \n# ℹ Row 1 of `y` was not matched at Column `b`.\n# 1 rows dropped from `y` that did not match `x`.\n```",
#>     "closed_by": {},
#>     "reactions": {
#>       "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7851/reactions",
#>       "total_count": 0,
#>       "+1": 0,
#>       "-1": 0,
#>       "laugh": 0,
...
#>       "eyes": 0
#>     },
#>     "timeline_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7851/timeline",
#>     "performed_via_github_app": {},
#>     "state_reason": {},
#>     "pinned_comment": {}
#>   },
#>   {
#>     "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7850",
#>     "repository_url": "https://api.github.com/repos/tidyverse/dplyr",
#>     "labels_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7850/labels{/name}",
#>     "comments_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7850/comments",
#>     "events_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7850/events",
#>     "html_url": "https://github.com/tidyverse/dplyr/pull/7850",
#>     "id": 4974798242,
#>     "node_id": "PR_kwDOAGIUpc72Qt5o",
#>     "number": 7850,
#>     "title": "Enhance README documentation with comprehensive examples and improved user guidance.md",
#>     "user": {
#>       "login": "muhammadsalek",
#>       "id": 180872571,
#>       "node_id": "U_kgDOCsflew",
#>       "avatar_url": "https://avatars.githubusercontent.com/u/180872571?v=4",
#>       "gravatar_id": "",
#>       "url": "https://api.github.com/users/muhammadsalek",
#>       "html_url": "https://github.com/muhammadsalek",
#>       "followers_url": "https://api.github.com/users/muhammadsalek/followers",
#>       "following_url": "https://api.github.com/users/muhammadsalek/following{/other_user}",
#>       "gists_url": "https://api.github.com/users/muhammadsalek/gists{/gist_id}",
#>       "starred_url": "https://api.github.com/users/muhammadsalek/starred{/owner}{/repo}",
#>       "subscriptions_url": "https://api.github.com/users/muhammadsalek/subscriptions",
#>       "organizations_url": "https://api.github.com/users/muhammadsalek/orgs",
#>       "repos_url": "https://api.github.com/users/muhammadsalek/repos",
#>       "events_url": "https://api.github.com/users/muhammadsalek/events{/privacy}",
#>       "received_events_url": "https://api.github.com/users/muhammadsalek/received_events",
#>       "type": "User",
#>       "user_view_type": "public",
#>       "site_admin": false
#>     },
...
#>     "milestone": {},
#>     "comments": 1,
#>     "created_at": "2026-07-25T07:35:19Z",
#>     "updated_at": "2026-07-25T07:40:27Z",
#>     "closed_at": {},
#>     "assignee": {},
#>     "author_association": "NONE",
#>     "issue_field_values": [],
...
#>     "draft": false,
#>     "pull_request": {
#>       "url": "https://api.github.com/repos/tidyverse/dplyr/pulls/7850",
#>       "html_url": "https://github.com/tidyverse/dplyr/pull/7850",
#>       "diff_url": "https://github.com/tidyverse/dplyr/pull/7850.diff",
#>       "patch_url": "https://github.com/tidyverse/dplyr/pull/7850.patch",
#>       "merged_at": {}
#>     },
...
#>     "closed_by": {},
#>     "reactions": {
#>       "url": "https://api.github.com/repos/tidyverse/dplyr/issues/7850/reactions",
#>       "total_count": 0,
#>       "+1": 0,
#>       "-1": 0,
#>       "laugh": 0,
...
#>       "eyes": 0
#>     },
#>     "timeline_url": "https://api.github.com/repos/tidyverse/dplyr/issues/7850/timeline",
#>     "performed_via_github_app": {},
#>     "state_reason": {}
#>   },
#>   {
