...
- [`gh_gql()`](https://gh.r-lib.org/dev/reference/gh_gql.md) : A simple
  interface for the GitHub GraphQL API v4.
- [`gh_next()`](https://gh.r-lib.org/dev/reference/gh_next.md)
  [`gh_prev()`](https://gh.r-lib.org/dev/reference/gh_next.md)
  [`gh_first()`](https://gh.r-lib.org/dev/reference/gh_next.md)
  [`gh_last()`](https://gh.r-lib.org/dev/reference/gh_next.md) : Get the
  next, previous, first or last page of results
- [`gh_rate_limit()`](https://gh.r-lib.org/dev/reference/gh_rate_limit.md)
...
- [`gh_tree_remote()`](https://gh.r-lib.org/dev/reference/gh_tree_remote.md)
  : Find the GitHub remote associated with a path
- [`gh_whoami()`](https://gh.r-lib.org/dev/reference/gh_whoami.md) :
  Info on current GitHub user and token
- [`print(`*`<gh_response>`*`)`](https://gh.r-lib.org/dev/reference/print.gh_response.md)
