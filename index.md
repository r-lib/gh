...
[`gh::gh_token()`](https://gh.r-lib.org/reference/gh_token.md) is used
as Personal Access Token (PAT). A token is needed for some requests, and
to help with rate limiting. gh can use your regular git credentials in
the git credential store, via the gitcreds package. Use
...
[`?gh::gh_token`](https://gh.r-lib.org/reference/gh_token.md) manual
...
Use the [`gh()`](https://gh.r-lib.org/reference/gh.md) function to
access all API endpoints. The endpoints are listed in the
[documentation](https://docs.github.com/rest).

The first argument of [`gh()`](https://gh.r-lib.org/reference/gh.md) is
the endpoint. You can just copy and paste the API endpoints from the
...
[`gh()`](https://gh.r-lib.org/reference/gh.md) call. E.g.
...
[`gh()`](https://gh.r-lib.org/reference/gh.md).
...
- The `GITHUB_PAT` and `GITHUB_TOKEN` environment variables are used, if
  ...
  [`?gh::gh_token`](https://gh.r-lib.org/reference/gh_token.md).
